...
export const LESSONS: readonly Lesson[] = [
  ...
  },
  {
    ...
    dayId: 2,
    ref: "Playbook §7.1",
    title: "ODPAC: the five stages of a conversation",
    body: [
      "Every conversation you run has the same five stages, in the same order: Opening, Development, Paraphrasing, Authentication, Closing. ODPAC. It is the one framework this academy teaches, it is what your mentor reads your daily report against, and it is the shape of a good chat whether or not an objection ever appears.",
      "Opening — the first fifteen seconds, and what they tell the guest about who they are dealing with. Use the standard greeting in full, give your name, and use theirs. You are opening a conversation, not starting a transaction, and the guest decides which one this is almost immediately.",
      "Development — where the need gets uncovered. Questions, before any recommendation. The six qualification fields are travel date, nationality and residence, destination and visa type, prior rejections, funds, and who is travelling. Nothing gets recommended before those are answered, because the answer changes what you would have recommended.",
      "Paraphrasing — playing the situation back, so both sides know it landed before anyone solves anything. Restate the problem in your own words and let them correct you. A paraphrase that gets corrected is the one that earned its place: the correction is the real problem arriving, and it is usually not the one they opened with.",
      "Authentication — backing what you say with something checkable, including the money. Every number a guest hears should be broken down, not rounded off: split the total into the Atlys service fee and the government or consulate fee, so they know what goes where. State the refund position precisely — the service fee comes back under AtlysProtect, the government fee does not — rather than saying “you're covered”. Look things up in Cadence before you state them, and never promise what you do not control.",
      "Closing — leaving the guest with no ambiguity about what happens next, and who owns it. Recap what was discussed, put a specific time on every commitment, ask whether there is anything else, and read the sign-off against their tone rather than delivering it on autopilot.",
      "The order carries the value. Authentication on its own is a good answer to a question nobody asked, and Development without an Opening sounds like an interrogation. This is also where objections live: an objection is a signal, not a refusal — someone who has decided against you goes quiet rather than argues — and it gets located in Development and Paraphrasing before it gets answered in Authentication. Price objections are frequently timeline objections, and timeline objections are frequently rejection fear. You cannot answer what you have not located.",
    ],
    example:
      "The pause rule from Day 2 is the honest version of Development. Silence and a question do the same job, and on a call the silence often works better, because the guest fills it with the concern they had not planned to admit.",
    commonMistake:
      "Jumping from Opening straight to Authentication because you recognise the question. Recognising the words is not the same as knowing the concern, and the two most common objections both disguise something else — which is exactly what Paraphrasing is there to catch.",
  },
  {
