...
export const LESSONS: readonly Lesson[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "Three tools get mistaken for it, and the third catches almost everybody. Freshchat is inbound chat and Freshdesk is tickets, so that is where the conversation lives. Grafana is funnel and pipeline numbers, not cases. And Walkie Talkie (WT) is how you call someone: it is a calling tool, not a dashboard. If you have heard WT described as the place you look up an application, unlearn it now, because that belief sends you to the wrong screen at the exact moment accuracy matters.",
...

  {
    ...
    body: [
      "Six tools, and an associate who uses them wrong is invisible to the team rather than merely disorganised. Cadence for leads and the outbound pipeline. Freshdesk for inbound tickets. Freshchat for live chat. Exotel for calls. Boomerang for your own performance. DD, the Daily Dashboard, for the team's.",
      ...
      "Freshdesk: every inbound email or chat inquiry becomes a ticket. Respond within the SLA, categorise correctly by visa type, query type and resolution type, escalate anything outside your scope rather than leaving it sitting, and write a complete resolution note before closing.",
      ...
      "Exotel: calls are recorded and logged automatically, and you set the disposition code after every one, because that is what builds your call history. Never use a personal phone for guest communication. If a call drops, call back within 60 seconds, and if you cannot reconnect, message via Freshchat immediately.",
      "Boomerang and DD are the two you will skip if nobody tells you why they matter. Boomerang is your own numbers: calls made, leads contacted, conversion rate, and the cold-lead list your re-engagement outreach should be built from. Your manager reviews it daily, so a sparse pipeline is visible whether or not you mention it. DD is the team's daily performance, including which lines of business are under target, and bringing one insight from it to the morning huddle is the difference between being engaged with the team's numbers and only your own.",
    ],
    example:
  ...
  },
  {
    ...
    body: [
      ...
      "Mid-shift: unresolved Freshdesk tickets, chats answered within SLA, check for escalations.",
      "End of shift: update all Cadence notes, set tomorrow's follow-up tasks, close out open tickets, and write a post-mortem on one difficult call — one thing you would do differently. Weekly: calibration, QA feedback, update your personal knowledge system, contribute something to the team knowledge base.",
