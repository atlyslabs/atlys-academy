import type { OdpacLoopRound } from "./types";

/**
 * Day 2 · the objection loop, run rather than read as a list.
 *
 ...
 */
export const ODPAC_LOOP_ROUNDS: readonly OdpacLoopRound[] = [
  {
    id: "odpacloop.price_is_timeline",
  ...
  {
    id: "odpacloop.timeline_is_rejection_fear",
...
export const ODPAC_LOOP_MAX_SCORE = ODPAC_LOOP_ROUNDS.reduce(
  (total, round) => total + round.steps.length,
  0,
);

/** Step labels, printed on the four slots. */
export const ODPAC_LOOP_STEP_LABELS = {
